...
# Радиус поиска: 0 — только свой город, 999 — без ограничения по географии
RADIUS_CITY = 0
RADIUS_ANY = 999
RADIUS_CHOICES: tuple[tuple[int, str], ...] = (
    (RADIUS_CITY, "только мой город"),
    (25, "до 25 км"),
    (50, "до 50 км"),
    (100, "до 100 км"),
    (300, "до 300 км"),
...
DEFAULT_SETTINGS: dict[str, str] = {
    ...
    "warning_delay": "4",           # секунд на чтение предупреждения до появления кнопки
}
